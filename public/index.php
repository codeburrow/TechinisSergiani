...
$router->get('/theatre/[α-ωΑ-Ω\w\d\!\.-]+', 'TheatreController', 'single_post');
$router->get('/cinema', 'CinemaController', 'showAllPosts');
$router->get('/cinema/[α-ωΑ-Ω\w\d\!\.-]+', 'CinemaController', 'single_post');
$router->get('/music', 'MusicController', 'showAllPosts');
$router->get('/music/[α-ωΑ-Ω\w\d\!\.-]+', 'MusicController', 'single_post');
$router->get('/photos', 'PhotosController', 'showAllPosts');
$router->get('/photos/[α-ωΑ-Ω\w\d\!\.-]+', 'PhotosController', 'single_post');
$router->get('/podcasts', 'PodcastsController', 'showAllPosts');
$router->get('/podcasts/[α-ωΑ-Ω\w\d\!\.-]+', 'PodcastsController', 'single_post');
//Admin - General
